...
# Inorder to use "string.ascii_uppercase" we import string
import string
...
class Boggle():
    ...
    def make_board(self):
        ...
        # Creeating a 5*5 boggle game board
    ...
    def check_valid_word(self, board, word):
        """Check if a word is a valid word in the dictionary and/or in the boggle board"""
